...
import 'package:node/features/cart/widgets/cart_products.dart';
import 'package:node/features/cart/widgets/cart_subtotal.dart';
          ...
          children: [
            ...
            Padding(
              ...
              child: CustomButton(
                  ...
                  text: 'Proceed to Buy (${user.cart.length}) items', onTap: (){
